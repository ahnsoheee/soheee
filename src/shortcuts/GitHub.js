...
const GitHub = ({ onClose }) => {
    return (
        <Window>
            <ButtonBar text="GitHub Issue Tracker.pdf" onClose={onClose} />
            <WindowContent>
                <br />
                GitHub Issue Tracker | 2020. 10 - 2020. 11 (팀)
                <br />
                <br />
                <Wrapper>
                ...
                <br />
                <br />
                - GitHub 이슈 관리 서비스 클론 프로젝트
                <br />
                - Issue를 조회, 생성, 수정, 삭제할 수 있습니다.
                <br />
                - Issue 목록을 필터링할 수 있습니다.
                <br />
                - Label을 조회, 생성, 수정, 삭제할 수 있습니다.
                <br />
                - Milestone을 조회, 생성, 수정, 삭제할 수 있습니다.
                <br />
                <br />
                <br />
                2. 기술 스택
